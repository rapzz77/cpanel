...
menu =`
⌬ ━━━〘 *INFO BOTZZ* 〙━━━ ⌬
❏➭ Nama Bot: *XzyyBotzz OFFICIAL*
❏➭ Creator: *Imba Store*
❏➭ Mode: *Public*
❏➭ ScOri *MODS*
❏➭ Recode *XzyyBotzz Official*
...
⌬ ━━━〘 𝙁𝙄𝙏𝙐𝙍 𝙋𝘼𝙉𝙀𝙇 〙━━━ ⌬
❏➭ .addpanel *<1gb udin1,62xxx>*
❏➭ .addadmin *<tes@gmail,user>*
❏➭ .ramlist
❏➭ .delusr *<Id>*
❏➭ .delsrv *<Id>*
❏➭ .pushmember *<teks>*
❏➭ .pushmemberv2 *<teks|Idgroup>*
❏➭ .pushkontak *<idgroup|tekspushkontak>*
❏➭ .buydomain
❏➭ .buyscdomain
❏➭ .listvps
❏➭ .listjasainstal
...
*_© XzyyBotzz-Official  || BY Imba Store_*`
m.reply(menu)
}
break
case "pushmemberv2": {
...
*_🗣️ : Boleh Nego?_*
*_👤 : Ga! harga Sudah Net Tidak Bisa Di Tawar !! Kurang Dikit? Jangan Maksa Silahkan Cari Seller Lain_*`
m.reply(admn)
}
break
case 'owner':
...
m.reply(owner)
  break
  case 'listpanelbot':{
  bot = `_*⚡READY PANNEL BOT BY XzyyBotzz⚡*_
...
_🚀 4 GB 2 CORE = 25.000_
_🚀 8 GB 4 CORE = 50.000_

*_Provider : Digital Ocean_*
*_Bergaransi Full 30 Hari !_*

*Sosmed Admin :*
_✅WhatsApp : Wa.me/6288276280732
_✅Youtube : http://youtube.com/@imbaStore1
_✅Instagram : @imbalonely
...
❏➭ .domain3 didindev.my.id 
❏➭ .domain4 sellerpannel.my.id 
❏➭ .domain5 panellku.my.id 
❏➭ .domain6 panellku.me 
❏➭ .domain7 panellku.biz.id 
❏➭ .domain8 panellku.com 
❏➭ .domain9 mypanel.biz.id 
❏➭ .domain10 panellku.art 
❏➭ .domain11 biistoreee.xyz 
❏➭ .domain12 renoffc.site 
❏➭ .domain13 renoffc.com 
❏➭ .domain14 kangpannel.xyz 
❏➭ .domain15 pannelfast.xyz 
┅═┅═❏ *BY XzyyBotzz* ❏═┅═┅
...
ctf = `👤Username : ${user.username}
🔐Password : ${password}
🌐Link Log : ${domain}
✨Tutor : https://youtu.be/quokLEMqcYg
`
m.reply(ctf)
